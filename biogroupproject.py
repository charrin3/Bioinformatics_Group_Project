...
g=a+geom_bar(stat="summary")+scale_x_discrete(labels=l)+ggtitle("Gsta2")
...
g=b+geom_bar(stat="summary")+scale_x_discrete(labels=l)+ggtitle("Slc7a12")
...
g=c+geom_bar(stat="summary")+scale_x_discrete(labels=l)+ggtitle("Ptpn5")
...
g=d+geom_bar(stat="summary")+scale_x_discrete(labels=l)+ggtitle("Atp12a")
...
g=e+geom_bar(stat="summary")+scale_x_discrete(labels=l)+ggtitle("Lhx2")
...
g=f+geom_bar(stat="summary")+scale_x_discrete(labels=l)+ggtitle("Synpr")
